...
column1 = dbc.Col(
    [
        dcc.Markdown(
            ...
            This model is also very difficult to interpret, in the sense that changes in values don't have a straightforward effect on the price like you might see from a multiple regression model.
